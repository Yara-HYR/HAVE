...
def parse_args():
    ...
    parser.add_argument('--carla_rpc_port_eval', default=4152, type=int)
    parser.add_argument('--carla_tm_port_eval', default=14152, type=int)
    ...
    parser.add_argument('--selected_speed', default=60, type=int)
...
def main():
    ...
    for step in range(args.num_train_steps):
        ...
        replay_buffer.add(obs["perception"], action,
                          curr_reward, reward,
        ...
        episode_step += 1
    agent.save(model_dir, step)
    evaluate(args, image_dir, eval_env, agent, video, 20, L, step,args.selected_weather,
             do_carla_metrics=args.do_carla_metrics)
