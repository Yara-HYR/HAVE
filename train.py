...
from agents.navigation.carla_env_v3 import CarlaEnv
...
def parse_args():
    ...
    # eval
    parser.add_argument('--eval_freq', default=40, type=int)  # TODO: master had 10000
    ...
    parser.add_argument('--port', default=7111, type=int)
...
def evaluate(env, agent, video, num_episodes, L, step, device=None, embed_viz_dir=None, do_carla_metrics=None):
    ...
    # agent.actor.load_state_dict(torch.load('/home/hyr/RL/deep_bisim4control/save/model/actor_99910.pt'))
    # agent.critic.load_state_dict(torch.load('/home/hyr/RL/deep_bisim4control/save/model/critic_99910.pt'))
    # agent.decoder.load_state_dict(torch.load('/home/hyr/RL/deep_bisim4control/save/model/decoder_99910.pt'))
    # # carla metrics:
    ...
    for i in range(num_episodes):
        ...
        L.log('eval/dist_driven_this_episode', dist_driven_this_episode, step)
...
def main():
    ...
    for step in range(args.num_train_steps):
        if done:
            ...
            if episode % args.eval_freq == 0 and step>0:
